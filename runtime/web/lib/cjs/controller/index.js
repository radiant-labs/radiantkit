...
class RadiantKitController {
    ...
    static createController(client_id, f, width, height) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return new RadiantKitController(yield new radiantkit_1.RadiantKitAppController(client_id, f, width, height));
        });
    }
    /**
