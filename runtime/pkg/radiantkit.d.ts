...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h1d1be77abbb1dada: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h82bea7c9fe9d9aa6: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h33b8f7a9ce2a67a7: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hfff5a65cc1f81448: (a: number, b: number) => void;
