use radiant_core::{RadiantMessage, RadiantTool, RadiantRectangleNode};
...
async fn run() {
    ...
    app.scene.add(radiant_core::RadiantNodeType::Rectangle(RadiantRectangleNode::new(0, [100.0, 100.0])));
